...
def lambda_handeler(event, context):
    ...
    filter_pattern = {}
    filter_pattern[400] = "filter @message like /dynamic script/ and @message like /error/| parse @message 'TransactionTrackerServiceController : *===== ' as guid| stats count(*) by guid"
